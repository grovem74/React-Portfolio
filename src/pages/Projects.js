    ...
    <Container className='pages' id='projects'>
      ...
      <Row>
        ...
        <Col s={8} className='center-align'>
          ...
          <img src="/assets/images/entertainMe.png" alt="entertainMe" className="project-pics" />
          <div>
      ...
      <Row>
        ...
        <Col s={8} className='center-align'>
          ...
          <img src="/assets/images/beGreen.png" alt="Be" className="project-pics" />
          <div>
            <div className="center-align project-buttons">
      ...
      <Row>
        ...
        <Col s={8} className='center-align'>
          ...
          <img src="/assets/images/eatDaBurger.png" alt="Eat-Da-Burger" className="project-pics" />
          <div>
            <div className="center-align project-buttons">
      ...
      <Row>
        ...
        <Col s={8} className='center-align'>
          ...
          <img src="/assets/images/README.gif" alt="README Generator" className="project-pics" />
          <div>
            <div className="center-align project-buttons">
      ...
      <Row>
        ...
        <Col s={8} className='center-align'>
          ...
          <img src="/assets/images/TeamTracker.gif" alt="Team Tracker" className="project-pics" />
          <div>
            <div className="center-align project-buttons">
